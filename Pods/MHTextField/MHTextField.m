...
- (void)setup{
    ...
    self.previousBarButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"<  ", @"<  ") style:UIBarButtonItemStyleBordered target:self action:@selector(previous:)];
    self.nextBarButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"  >", @"  >") style:UIBarButtonItemStyleBordered target:self action:@selector(next:)];
