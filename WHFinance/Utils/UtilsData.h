...
typedef void (^GetMoneyBlock)(UserData *user);
...
-(void)hideAlert;//隐藏提示框

-(NSString *)getVersions;//获得版本号

//alertView or alertController
//- (void)showAlertWithTitle:(NSString *)titleString detailsText:(NSString *)detailsString type:(NSString *)typeString dele:(UIViewController *)dele block:(parameterBlcok)paramB;
