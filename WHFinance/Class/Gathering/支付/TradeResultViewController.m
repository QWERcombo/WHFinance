...
- (UIView *)createMainView  {
    ...
    UILabel *hint = [UILabel lableWithText:[NSString stringWithFormat:@"已成功收款%@元", self.orderModel.orderAmount.length ?self.orderModel.orderAmount:self.cashStr] Font:FONT_ArialMT(13) TextColor:[UIColor Grey_WordColor]];
...
- (void)checkStatus {//查询订单状态 2秒一次
    ...
    [paramDic setObject:[NEUSecurityUtil FormatJSONString:@{@"userToken":[UserData currentUser].userToken,@"orderId":@"2551683"}] forKey:@"transc.queryOrder"];
